 ...
 */
function polygonRemoveCollinearPoints(polygon: Array<Float32Array>, precision: f32){
    let num: u32 = 0;
 ...
 */
function polygonRemoveDuplicatePoints(polygon: Array<Float32Array>, precision: f32){
